...
<html lang="en">
<head>
    <title>Sakura Dreams - Chef Secundario 4  </title>
    <meta charset="UTF-8">
...
<body style="background-color: #fbd5e5;">
    ...
    <h1>Sakura Dreams - Chef Secundario 4  </h1>
    <div class="container recipe-container">
        <div class="fixed-left">
            <img src="../../imagenes/personal_ChefRamenFideos.jpg" class="recipe-image" alt="Chef Secundario 4  ">
            <p class="recipe-description">Se centra en platos de ramen, udon y soba, brindando comodidad en cada plato.</p>
        </div>
            <div class="steps-container">
                <div class="row ingredients">
                    <div class="col-12">
                        ...
                        <ul>
                            <li class="ingredient-item">Yuki Matsuda </li>
                        </ul>
                        <h4 class="recipe-title">Puesto:</h4>
                        <ul>
                            <li class="ingredient-item">Chef de ramen y fideos</li>
                        </ul>
                        <h4 class="recipe-title">Biografía:</h4>
                        <ul>
                            <li class="ingredient-item">Yuki Matsuda es el experto en ramen y fideos de Sakura Dreams. Nacido en Fukuoka, lugar de nacimiento del tonkotsu ramen, Yuki ha dedicado su carrera a perfeccionar el arte del ramen. Pasó años estudiando con maestros de ramen en Japón y en el extranjero, aprendiendo los secretos de elaborar caldos ricos y fideos elásticos. Yuki es conocido por sus innovadoras creaciones de ramen, que combinan sabores tradicionales con toques modernos. Cuando no está en la cocina, le gusta andar en bicicleta y experimentar con nuevas recetas de ramen en casa.</li>
                        </ul>
                    </div>
                </div>
            </div>    
