...
<html lang="en">
<head>
    <title>Sakura Dreams - Mariscos Teppanyaki</title>
    <meta charset="UTF-8">
...
<body style="background-color: #fbd5e5;">
    ...
    <h1>Sakura Dreams - Mariscos Teppanyaki</h1>
    <div class="container recipe-container">
        <div class="fixed-left">
            <img src="../../imagenes/platofuerte_Teppanyaki Seafood.jpg" class="recipe-image" alt="Mariscos Teppanyaki">
            <p class="recipe-description">Mariscos chisporroteantes cocinados en una plancha de hierro. Ingredientes:</p>
        </div>
