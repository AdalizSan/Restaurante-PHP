        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <?php 
                        $elementosHeader = [
                            ["directorio" => "../index.html", "Nombre" => "Inicio", "clase"=> "nav-item"],
                            ["directorio" =>"../Platillos/menu.php", "Nombre" => "Menú", "clase"=> "nav-item"],
                            ["directorio" =>"../InfoPersonal/personalSakura.html", "Nombre" => "Nuestro Equipo", "clase"=> "nav-item"],
                            ["directorio" =>"../recetasPlatillos/recetas.html", "Nombre" => "Nuestras Recetas", "clase"=> "nav-item"],
                            ["directorio" =>"../Resenias/resenias.html", "Nombre" => "Reseñas", "clase"=> "nav-item"],
                            ["directorio" =>"#", "Nombre" => "Reservaciones", "clase"=> "nav-item active"]
                        ];
